...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="">
      <div className="border-b" style={{ background: "#FAFAFA" }}>
          ...
          <div className="flex justify-between py-14">
            <div className="lg:flex w-full justify-between">
              <div className="lg:flex md:grid grid-cols-3 gap-8 space-y-10 md:space-y-0 w-full md:5/12 lg:w-7/12 justify-between">
                ...
                <div>
                  <h4 className="text-title font-bold mb-5">Legal</h4>
                  <ul className="space-y-3 text-sm font-bold text-text-color">
                    <li><Link href="/">About Us</Link></li>
                    <li><Link href="/">Carrier</Link></li>
                    <li><Link href="/">We are hiring</Link></li>
                ...
                <div>
                  <h4 className="text-title font-bold mb-5">Features</h4>
                  <ul className="space-y-3 text-sm font-bold text-text-color">
                ...
                <div>
                  <h4 className="text-title font-bold mb-5">Resources</h4>
                  <ul className="space-y-3 text-sm font-bold text-text-color">
              ...
              <div className="w-full mt-10 lg:mt-0 md:w-6/12 lg:w-4/12">
                ...
                <div style={{ display: "flex" }}>
                  ...
                  <Button
                    ...
                    variant="contained"
                    className={`w-2/5 rounded-none ${montserrat.className}`}
                    color="primary"
      ...
      <div style={{ background: "#FAFAFA" }}>
        <div className="container mx-auto px-10 lg:px-20">
          <div className="flex justify-between py-5">
            <div className="text-sm text-text-color font-bold">
