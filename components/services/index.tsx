  ...
  return (
    <div className="py-10 md:py-20">
      ...
      <div className="space-y-2 w-full text-center">
        <div className="text-lg md:text-xl">Featured Products</div>
        <h2 className="text-xl md:text-2xl font-bold text-tex">
          THE BEST SERVICES
        </h2>
      ...
      <div className="w-full flex flex-col md:flex-row justify-center">
        <div className="w-full md:w-4/5 mt-10 md:mt-20 flex flex-col md:flex-row justify-between items-center">
          <div className="flex flex-col justify-center items-center mb-6 md:mb-0">
            ...
            <h3 className="text-main-text mb-3 text-2xl font-bold">
              Easy Wins
            </h3>
            <p className="text-text-color text-sm w-3/5 text-center">
          ...
          <div className="flex flex-col justify-center items-center mb-6 md:mb-0">
            ...
            <h3 className="text-main-text mb-3 text-2xl font-bold">Concrete</h3>
            <p className="text-text-color text-sm w-3/5 text-center">
